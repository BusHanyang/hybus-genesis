          ...
          arrCyc.push(
            ...
            >
              ...
              <RouteStations id="cycdot" key={i + 1}>
                <Circle
                  className={`${props.isPrevStop('cycle', i + 1) ? 'bg-chip-red' : 'bg-zinc-200 dark:bg-slate-500'} grid grid-rows-2 relative`}
                >
                  <SpecialStopsText
                    key={0}
                    lang={i18n.language}
                    className={
                      props.isPrevStop('cycle', 3)
                        ? 'text-chip-red'
          ...
          arrYes.push(
            ...
            >
              ...
              <RouteStations id="yesdot" key={i + 1}>
                <Circle
                  className={`${props.isPrevStop('yesulin', i + 1) ? 'bg-chip-green' : 'bg-zinc-200 dark:bg-slate-500'} grid grid-rows-2 relative`}
                >
                  <SpecialStopsText
                    key={1}
                    lang={i18n.language}
                    className={
                      props.isPrevStop('yesulin', 3)
                        ? 'text-chip-green'
                        : 'text-zinc-200 dark:text-slate-500'
                    }
                  >
          ...
          arrJun.push(
            ...
            >
              ...
              <RouteStations id="jundot" key={i + 1}>
                <Circle
                  className={`${props.isPrevStop('jungang', i + 1) ? 'bg-chip-purple' : 'bg-zinc-200 dark:bg-slate-500'} grid grid-rows-2 relative`}
                >
                  <SpecialStopsText
                    key={2}
                    lang={i18n.language}
                    className={
                      props.isPrevStop('jungang', i + 1)
                        ? 'text-chip-purple'
                        : 'text-zinc-200 dark:text-slate-500'
                    }
                  >
