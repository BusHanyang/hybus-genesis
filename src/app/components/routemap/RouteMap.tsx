...
const RouteMap = (props: {
    ...
    useEffect(() => {
        ...
        Responsive([dotDir, dotCyc, dotYes, dotJun], [lineDir, lineCyc, lineYes, lineJun])
    }, [])

    useEffect(() => {
        Animation({dotDir: dotDir, dotCyc: dotCyc, dotJun: dotJun, dotYes: dotYes}, props.tab, timeCheck, timetable)
    }, [timetable, props.tab])
